...
int dht_gpio = 4; // my default DHT pin = 4
float humidity = 0.;
float temperature = 0.;
...
int dht22_get_signal_level(int timeout, bool state)
{
...
int dht22_read()
{
	...
	gpio_set_direction(dht_gpio, GPIO_MODE_INPUT); // change to input mode
 ...
 * DHT22 Sensor task
 */
static void dhd22_task(void *pvParameter)
{
...
{
	xTaskCreatePinnedToCore(&dhd22_task, "dhd22_task", DHT22_TASK_STACK_SIZE, NULL, DHT22_TASK_PRIORITY, NULL, DHT22_TASK_CORE_ID);
}
